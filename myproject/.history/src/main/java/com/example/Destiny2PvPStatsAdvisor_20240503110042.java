...
public class Destiny2PvPStatsAdvisor {
    ...
    private static final String API_KEY = "bbdd5b34b65f48129a16822d7d59c4e6";
    ...
    private static void provideGameplaySuggestions(JSONObject stats) {
        ...
        /*double averageKillDistance = stats.getJSONObject("Response").getJSONObject("allPvP").getJSONObject("allTime")
                .getJSONObject("averageKillDistance").getDouble("basic").getDouble("value");
        double averageLifespan = stats.getJSONObject("Response").getJSONObject("allPvP").getJSONObject("allTime")
                .getJSONObject("averageLifespan").getDouble("basic").getDouble("value");
        double killsDeathsRatio = stats.getJSONObject("Response").getJSONObject("allPvP").getJSONObject("allTime")
                .getJSONObject("killsDeathsRatio").getDouble("basic").getDouble("value");
        double winLossRatio = stats.getJSONObject("Response").getJSONObject("allPvP").getJSONObject("allTime")
                .getJSONObject("winLossRatio").getDouble("basic").getDouble("value");
